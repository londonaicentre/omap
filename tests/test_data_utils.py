...
def sample_mappings():
    ...
    return [
        ConceptMatch(source_key=1, target_concept_id=1001, similarity_score=0.9, confirmation_status="False", first_confirmation_timestamp=None, last_update_timestamp=None),
        ConceptMatch(source_key=2, target_concept_id=1002, similarity_score=0.8, confirmation_status="True", first_confirmation_timestamp=None, last_update_timestamp=None),
        ConceptMatch(source_key=3, target_concept_id=1003, similarity_score=0.85, confirmation_status="Rejected", first_confirmation_timestamp=None, last_update_timestamp=None),
        ConceptMatch(source_key=4, target_concept_id=1004, similarity_score=0.7, confirmation_status="False", first_confirmation_timestamp=None, last_update_timestamp=None),
    ]
